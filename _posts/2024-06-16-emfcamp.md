...
![A real-life version of Microsoft Paint, complete with Windows toolbars and pixel-style tools. There is a screen that is switched off and a sign saying that the installation is currently broken.]({% link assets/blog/emf_paint.jpeg %}){:.blog_photo}

There was a musical Tesla coil:[^2]

![A Tesla coil shooting a bolt of lightning into the air.]({% link assets/blog/emf_tesla_coil.jpeg %}){:width='40%' .blog_photo}

And there was a game of Asteroids projected on the side of a hill with LASERS![^3]

![The classic game of Asteroids, projected on the side of a hill amid trees, using white lasers.]({% link assets/blog/emf_asteroids.jpeg %}){:width='60%' .blog_photo}
